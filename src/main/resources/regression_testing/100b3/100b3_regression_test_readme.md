...
Created with: DL4J 1.0.0-beta3 Release
...
public class LSTMCharModellingExample {
	public static void main( String[] args ) throws Exception {
        ...
        net.save(new File("GravesLSTMCharModelingExample_100b3.bin"));
        Nd4j.getRandom().setSeed(12345);
        INDArray input = Nd4j.rand(new int[]{3, iter.inputColumns(), 10});
        try(DataOutputStream dos = new DataOutputStream(new FileOutputStream(new File("GravesLSTMCharModelingExample_Input_100b3.bin")))){
            Nd4j.write(input, dos);
        }
        INDArray output = net.output(input);
        try(DataOutputStream dos = new DataOutputStream(new FileOutputStream(new File("GravesLSTMCharModelingExample_Output_100b3.bin")))){
...
public class CustomLayerExample {
    ...
    private static void runInitialTests() throws IOException {
        ...
        net.save(new File("CustomLayerExample_100b3.bin"));
        Nd4j.getRandom().setSeed(12345);
        INDArray input = Nd4j.rand(new int[]{3, nIn});
        try(DataOutputStream dos = new DataOutputStream(new FileOutputStream(new File("CustomLayerExample_Input_100b3.bin")))){
            Nd4j.write(input, dos);
        }
        INDArray output = net.output(input);
        try(DataOutputStream dos = new DataOutputStream(new FileOutputStream(new File("CustomLayerExample_Output_100b3.bin")))){
            Nd4j.write(output, dos);
        }
...
//            .updater(new Adam(0.05))
        ...
        net.save(new File("VaeMNISTAnomaly_100b3.bin"));
        Nd4j.getRandom().setSeed(12345);
        INDArray input = Nd4j.rand(3, 28*28);
        try(DataOutputStream dos = new DataOutputStream(new FileOutputStream(new File("VaeMNISTAnomaly_Input_100b3.bin")))){
            Nd4j.write(input, dos);
        }
        INDArray output = net.output(input);
        try(DataOutputStream dos = new DataOutputStream(new FileOutputStream(new File("VaeMNISTAnomaly_Output_100b3.bin")))){
            Nd4j.write(output, dos);
        }
...
//        recordReaderTest.initialize(testData);
        ...
        if (new File(modelFilename).exists()) {
            ...
            model.save(new File("HouseNumberDetection_100b3.bin"));
            Nd4j.getRandom().setSeed(12345);
            INDArray input = Nd4j.rand(new int[]{3, 3, 416, 416});
            try(DataOutputStream dos = new DataOutputStream(new FileOutputStream(new File("HouseNumberDetection_Input_100b3.bin")))){
                Nd4j.write(input, dos);
            }
            INDArray output = model.outputSingle(input);
            try(DataOutputStream dos = new DataOutputStream(new FileOutputStream(new File("HouseNumberDetection_Output_100b3.bin")))){
                Nd4j.write(output, dos);
            }
